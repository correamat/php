...
Class Mongo_db{
    ...
    function __construct($param)
    {
        ...
        $this->CI->load->config('mongo_db'); //RETORNA TRUE OU FASE
        $this->config = $this->CI->config->item('mongo_db'); //RETORNA AS CONFIGURAÇÕES DEFINIDAS NO MONGODB
        $this->param = $param;
        $this->connect();
    }
...
//			$this->connect->close();
    ...
    public function get($collection = "")
    {
        ...
        try{
            ...
            echo "<br>";
            var_dump($this->config[$this->activate]['database']);
            echo "<br>";
            var_dump($collection);
            echo "<br>";exit;*/
            //new MongoDB\Collection(Manager $manager, $databaseName, $collectionName, array $options = [])
            ...
            $options = array();
            $collection = new MongoDB\Collection($this->connect, $this->config[$this->activate]['database'], $collection, $options); //$this->db->selectCollection($collection);
            $documents = $collection->find($this->wheres, $options);
